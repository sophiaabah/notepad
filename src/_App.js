...
export default function App() {
  const [notes, setNotes] = React.useState(fetch("") || []); // load db here. If its empty would it be undefined? can i make the notes column have an array on default or is the first option better
          ...
          <form className="measure center">
            ...
            <div className="lh-copy mt3">
              ...
              <a
                ...
                className="f6 link dim black underline db"
              >
                Sign up
              </a>
            </div>
